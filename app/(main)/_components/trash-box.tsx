					...
					>
						...
						<div className="flex items-center">
							<div
								...
								className="rounded-sm p-2 hover:bg-neutral-200 dark:hover:bg-neutral-600 transition"
							>
							...
							<ConfirmModal onConfirm={() => onDelete(document._id)}>
								<div
									role="button"
									className="
                                rounded-sm p-2 hover:bg-neutral-200 dark:hover:bg-neutral-600 transition"
								>
